...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo U('List/see');?>"  data-title="list" href="javascript:void(0)">list</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a data-href="http://localhost/secms/admin.php/Admin/see" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
			</ul>
		</dd>
	</dl>
</div>
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="http://localhost/secms/admin.php/gyjx/index"></iframe>
	</div>
</div>
</section>
<!--_footer 作为公共模版分离出去-->
