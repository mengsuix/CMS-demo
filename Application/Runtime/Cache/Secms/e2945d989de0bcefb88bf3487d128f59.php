...
<article class="page-container">
	<form class="form form-horizontal" enctype="multipart/form-data" id="form-article-add" name="kfzx" method="post" action="<?php echo U('Kfzx/add');?>">

						<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">字段值：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="articletitle" name="field">
			</div>
		</div>
...
<script type="text/javascript" src="/secms/Public/admin/lib/jquery.validation/1.14.0/jquery.validate.js"></script> 
<script type="text/javascript" src="/secms/Public/admin/lib/jquery.validation/1.14.0/validate-methods.js"></script> 
<script type="text/javascript" src="/secms/Public/admin/lib/jquery.validation/1.14.0/messages_zh.js"></script>
<script type="text/javascript" src="/secms/Public/admin/lib/webuploader/0.1.5/webuploader.min.js"></script> 
